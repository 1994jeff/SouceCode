...
import com.yhx.app.adapter.LookListAdapter;
...
public class MyLookActivity extends Activity implements UpdateHandler {
			...
			public void onClick(View v) {
				...
				ok.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						HttpHelper.asyncPost(Constants.URL + "/Trade/look_delete.do", params, new Callback() {
	...
	public void loadData( int pn) {
		...
		HttpHelper.asyncPost(Constants.URL + "/Trade/look_list.do",
				params, new Callback() {
					@Override
					public void dataLoaded(Message msg) {
						footer.setVisibility(View.GONE);
