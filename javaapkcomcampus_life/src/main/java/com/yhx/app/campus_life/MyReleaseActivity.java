...
public class MyReleaseActivity extends Activity implements UpdateHandler {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_myrelease2);
			...
			public void onClick(View v) {
				...
				ok.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						HttpHelper.asyncPost(Constants.URL + "/Trade/shop_delete.do", params, new Callback() {
	...
	public void loadData( int pn) {
		...
		HttpHelper.asyncPost(Constants.URL + "/Trade/shop_info.do",
				params, new Callback() {
					@Override
					public void dataLoaded(Message msg) {
						footer.setVisibility(View.GONE);
