...
import com.yhx.app.campus_life.GuideFragment.GuidePageAdapter;
...
public class ShopInfoActivity extends Activity {
		...
		btn_right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (users != null) {
					...
					HttpHelper.asyncPost(Constants.URL + "/Trade/collection_add.do", params, new Callback() {
	...
	private void initData() {
		...
		if (itemList.getPicture() != null && !itemList.getPicture().equals("")) {
			Log.d("itemList.getPicture()", "initData: "+itemList.getPicture());
