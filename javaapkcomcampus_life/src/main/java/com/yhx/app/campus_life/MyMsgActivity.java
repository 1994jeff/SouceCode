...
import com.yhx.app.view.PullDownView;
import com.yhx.app.view.PullDownView.UpdateHandler;
...
public class MyMsgActivity extends Activity implements UpdateHandler{
	...
	private List<com.yhx.app.entity.Message> listDatas = new ArrayList<com.yhx.app.entity.Message>();
			...
			public void onClick(View v) {
				...
				ok.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						HttpHelper.asyncPost(Constants.URL + "/Trade/msg_delete.do", params, new Callback() {
	...
	public void loadData(String string,int pn) {
		...
		HttpHelper.asyncPost(Constants.URL + "/Trade/msg_list.do",
				params, new Callback() {
					@Override
					public void dataLoaded(Message msg) {
						footer.setVisibility(View.GONE);
						...
						PageModel<com.yhx.app.entity.Message> pm = PageModel.jsonConvertMsg(json);
